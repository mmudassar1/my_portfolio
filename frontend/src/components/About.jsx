    ...
    return (
        <section className="py-24 max-w-[1400px] mx-auto px-6 md:px-10" id="about">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-24">
                <div className="about-content order-2 lg:order-1" data-aos="fade-up">
                    ...
                    <p className="text-[#9ca3af] text-lg leading-relaxed mb-10">
                        A results-driven Full Stack Developer with 4 years of experience in the field, including 2 years of professional experience at Digigitz Software House. I have a strong background in the MERN stack and specialize in building scalable, high-performance web applications, with a proven ability to deliver clean, efficient code for real-world projects.                    </p>
                ...
                <div className="flex justify-center items-center order-1 lg:order-2" data-aos="zoom-in">
