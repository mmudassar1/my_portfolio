                        ...
                        <div className="bg-white/5 p-8 rounded-2xl border border-white/5 h-full">
                            ...
                            <div className="flex gap-4">
                                {[
                                    ...
                                    { icon: <><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></>, url: "https://linkedin.com/in/mmudassar" },
